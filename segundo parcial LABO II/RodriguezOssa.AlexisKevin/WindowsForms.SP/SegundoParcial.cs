...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Rodriguez Ossa, Alexis Kevin");
            this.Text = "Rodriguez Ossa, Alexis Kevin";
        }
        ...
        private void c_gomas_EventoPrecio(object sender, EventArgs e)
        {
            ...
            bool todoOK = Ticketeadora.ImprimirTicket((double)sender);
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
             valor = dataGridView1.Rows[dataGridView1.Rows.Count-1].Cells[1].Value.ToString();
            }
            catch (Exception)
            {
...
MessageBox.Show(valor);*/
                ...
                this.cn = new SqlConnection(Properties.Settings.Default.dataBase);
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Ha ocurrido un error al intentar agregar los datos a la tabla.");
            }
        ...
        private void btnPunto8_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ha ocurrido un error al intentar eliminar el dato de la tabla.");
            }
        }
