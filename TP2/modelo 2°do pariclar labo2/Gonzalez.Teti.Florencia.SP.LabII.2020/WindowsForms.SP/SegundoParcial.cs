...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        private void btnPunto3_Click(object sender, EventArgs e)
        {
            ...
            catch (CartucheraLlenaExceptio ex)
            {
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            this.c_gomas.EventoPrecio += new SuperaPrecioDelegado(c_gomas_EventoPrecio);
            this.c_lapices.EventoPrecio += new SuperaPrecioDelegado(c_gomas_EventoPrecio);
        ...
        {
            bool todoOK = Ticketeadora.ImprimirTicket(precio);//Reemplazar por la llamada al método de clase ImprimirTicket
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            //Reemplazar por la llamada al método correspondiente del OpenFileDialog

            if (rta == DialogResult.OK)
            {
                //leer el archivo seleccionado por el cliente y mostrarlo en txtVisorTickets
                string ruta = openFileDialog1.FileName;
                this.txtVisorTickets.Text = File.ReadAllText(ruta);
            }
        }
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.cn = new SqlConnection(Properties.Settings.Default.conexionSP);

                //Configurar el SqlDataAdapter (y su selectCommand)                        
                this.da = new SqlDataAdapter();
                this.da.SelectCommand = new SqlCommand("SELECT * FROM utiles", cn);
                this.da.Fill(this.dt);
                this.dataGridView1.DataSource = this.dt;
            }
            catch (Exception)
            {
                MessageBox.Show("Ha ocurrido un error al listar los utiles.");
            }
        }
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            this.da.InsertCommand = new SqlCommand("INSERT INTO utiles (marca, precio, tipo) VALUE (@marca, @precio, @tipo)", cn);
            ...
            fila[3] = this.lapiz.GetType().ToString();
        ...
        private void btnPunto9_Click(object sender, EventArgs e)
        {
            ...
            this.da.UpdateCommand = new SqlCommand("UPDATE utiles SET marca=@marca, precio=@precio WHERE id=@id", cn);
            ...
            DataRow modificar = this.dt.Rows[this.dt.Rows.Count - 1];
            try
            {
            modificar[1] = "barrillito";
            modificar[2] = 72;
            }
            catch (Exception)
            {
