...
int main()
{
    ...
    do
    {
        ...
        switch(opcion)
        {
            ...
            case 2:
            {
                mostrarTodosLosCamiones(listaCamiones,TAM_CAMIONES,listaChoferes,TAM_CHOFERES,listaMarca,3);
                break;
            }
            case 3:
            {
                mostrarChoferesConCamiones(listaCamiones,TAM_CAMIONES,listaChoferes,TAM_CHOFERES,listaMarca,TAM_MARCA);
                break;
            }
            case 4:
            {
            ...
            case 6:
            {
                modificarCamion(listaCamiones,TAM_CAMIONES,listaChoferes,TAM_CHOFERES,listaMarca,3);
                break;
            }
            case 7:
            {
