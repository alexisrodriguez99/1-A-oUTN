 ...
 *
 */
static int addNode(LinkedList* this, int nodeIndex,void* pElement)//27/7 al 31/7 primer llamado-------3/8 al 7/8
{
    int returnAux = -1;
    Node* prev;
    Node* next;
    Node* nuevoNodo;
    int largoLucas=ll_len(this);
    if(this!=NULL  && nodeIndex>-1 )
    {
        if(nodeIndex<=largoLucas)
        {
            // printf("1234657");
            ...
            {
                next=getNode(this,0);
                this->pFirstNode=nuevoNodo->pNextNode;
    ...
    if(this!=NULL)
    {
        ...
        for(i=0; i<len; i++)
        {
            /*nodo=getNode(this,i);
             free(nodo);
             nodo=NULL;*/
            ll_remove(this,0);// una forma mas optima usando la funcion
        }
        returnAux=0;
    }
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        valor=ll_indexOf(this,pElement);
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        for(i=0; i<ll_len(this2); i++)
        {
            ...
            valor=ll_contains(this,elemento);
            if(valor!=1)
            {
                returnAux=0;
                break;
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this!=NULL && from>-1 && from<=ll_len(this) && to>from && to<=ll_len(this))
    {
        ...
        for(i=from; i<to; i++)
        {
            ...
            ll_add(cloneArray,pElement);//verificar con el retorno del ll_dd (si no me retorna algo 1 entonces borro la lista y dejo de copiar la lista)
...
LinkedList* ll_filter(LinkedList* this, int(*fn)(void* elemt))
{
...
LinkedList* ll_filter_parametro(LinkedList* this,int (*fn)(void* elemt,char* cadena),char* nombre)
{
    ...
    if(this!=NULL)
    {
        ...
        for(i=0; i<ll_len(this); i++)
        {
            if(fn(ll_get(this,i),nombre)==1)
            {
                elemento=ll_get(this,i);
            ll_add(newList,elemento);
            }
...
/*LinkedList* ll_filter_parametro2(LinkedList* this,int (*fn)(void* elemt,char* cadena,void* ement2),char* nombre,LinkedList this2)
{
    LinkedList* newList = NULL;
    void* elemento;
    int i;
    if(this!=NULL)
    {
        ...
        for(i=0; i<ll_len(this); i++)
        {
            if(fn(ll_get(this,i),nombre,this2)==1)
            {
                elemento=ll_get(this,i);
            ll_add(newList,elemento);
            }
