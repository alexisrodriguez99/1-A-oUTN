...
namespace WindowsForms.SP
{
    ...
    public partial class SegundoParcial : Form
    {
        ...
        {
            MessageBox.Show("Segota Ezequiel");
            this.Text = "Segota Ezequiel";
        }
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            this.c_gomas.LimitePrecio +=c_gomas_EventoPrecio;
            try
            {
        ...
        private void c_gomas_EventoPrecio(double sender)
        {
            bool todoOK = Cartuchera<Utiles>.ATexto(sender); //Reemplazar por la llamada al método de clase ImprimirTicket
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            foreach (Utiles item in this.c_gomas.Elementos)
            {
                ...
                fila["marca"] = ((Goma)item).marca;
                fila["precio"] = ((Goma)item).precio;
                fila["tipo"] = ((Goma)item).GetType().ToString();
            ...
            foreach (Utiles item in this.c_lapices.Elementos)
            {
                ...
                fila["marca"] = ((Lapiz)item).marca;
                fila["precio"] = ((Lapiz)item).precio;
                fila["tipo"] = ((Lapiz)item).GetType().ToString();
            ...
            foreach (Utiles item in this.c_utiles.Elementos)
            {
                ...
                fila["tipo"] = item.GetType().ToString();
